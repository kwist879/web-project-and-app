...
$userlist = mysqli_fetch_assoc($users);
...
echo "<b style='color:white;font-family: Arial;'>Привет,</b> <a href='admin.php'><strong style='color:white;'>".$login."</strong></a> | <a style='background-color:#C90004; color:white; padding: 4px; border-radius: 11%;' href='exit.php'>Выход</a>";
}
?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="basicInfo-tab" data-toggle="tab" href="#basicInfo" role="tab" aria-controls="basicInfo" aria-selected="true">Пользователи</a>
                                    </li>
                                    ...
                                    <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label style="font-weight:bold;">Пользователь <?php echo $userlist['id'] ?></label>
                                            </div>

                                            <div class="col-md-8 col-6">
                                                
                                                <?php echo $userlist['surname']?>
                                            </div>
                                            <div>
